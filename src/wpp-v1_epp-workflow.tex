...
\begin{tikzpicture}
  ...
  \node[participant] at (21,1.5) {Financial Institution};
	...
	\draw[box] (0,-8.5) -- (0,-9.5);
                      ...
                      \draw[solidarrow]
                      	(0.2,-1) -- node[txt, txt, text width=3cm, midway,above] {1 } (6.8,-1);
                      \draw[solidarrow]
                      	(7.2,-2.5) -- node[txt, txt, text width=3cm, midway,above] {2 } (13.8,-2.5);
                      \draw[dashedarrow]
                      	(13.8,-4) -- node[txt, txt, text width=3cm, midway,above] {3 } (7.2,-4);
                      \draw[solidarrow]
                     	 (7.2,-5.5) -- node[txt, txt, text width=3cm, midway,above] {4 } (13.8,-5.5);
                      \draw[solidarrow]
                      	(14.2,-5.5) -- node[txt, txt, text width=3cm,  midway,above] {5 } (20.8,-5.5);
                      \draw[dashedarrow]
                      	(20.8,-7) -- node[txt, txt, text width=3cm,  midway,above] { } (14.2,-7);
                      \draw[dashedarrow]
                      	(13.8,-7) -- node[txt, txt, text width=3cm,  midway,above] {6 } (7.2,-7);
                      \draw[dashedarrow]
                      	(7.2,-7.5) -- (7.6,-7.5) -- node[txt, txt, text width=3cm, midway,right] {7 } (7.6,-9) -- (7.2,-9);
                      \draw[dashedarrow]
                      	(6.8,-9) -- node[txt, txt, text width=3cm,  midway,above] {8 } (0.2,-9);
