...
\begin{tikzpicture}
  ...
  \node[txt, participant] at (0,1.5) {Consumer};
  	\node[txt, icon] (icon1) at (0,3)
  		{\includegraphics[width=.1\textwidth]{consumer.png}};
  \node[txt, participant] at (7,2) {Pament Page \\ (Merchant)};
  	\node[txt, icon] (icon2) at (7,3)
  		{\includegraphics[width=.1\textwidth]{paymentpage.png}};
  \node[txt, participant] at (14,1.5) {Payment Gateway};
  	\node[txt, icon] (icon3) at (14,3)
  		{\includegraphics[width=.1\textwidth]{paymentgateway.png}};
  \node[txt, participant] at (21,1.5) {Financial Institution};
  	\node[txt, icon] (icon4) at (21,3)
