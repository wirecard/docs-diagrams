...
\begin{tikzpicture}
	...
	% Aid Lines
	\draw[line_mulberry] (-5,0) -- (-5,-20);
	\draw[line_night] (10,0) -- (10,-20);
	\draw[line_nightsky] (25,0) -- (25,-20);
    	
    	% Nodes
    	\fill[mulberry] (-5.1,-.75) rectangle (-4.9,-1.25);
    	\fill[nightsky] (10.1,-0.9) rectangle (9.9,-6.2);
    	\fill[sky] (25.1,-6.0) rectangle (24.9,-10.2);
    	\fill[sky] (24.8,-9) rectangle (24.7,-10.2);
    	\fill[nightsky] (10.1,-9) rectangle (9.9,-19.3);
    	\fill[nightsky] (10.2,-10) rectangle (10.3,-13.2);
    	\fill[sky] (25.1,-13) rectangle (24.9,-19.3);
