...
\draw[solidarrow]
	(30.2,-4) -- (30.6,-4) -- node[txt, right] {4.1 Generates QR code \\ in different sizes} (30.6,-5.5) -- (30.2,-5.5);
\draw[solidarrow]
...
\draw[solidarrow]
	(29.8,-14.5) -- node[txt, align=center, above] {7.2 Sends payment result notification} (20.2,-14.5);
\draw[solidarrow]
	(19.8,-16) -- node[txt, align=center, above] {8 Sends payment result notification} (10.2,-16);
