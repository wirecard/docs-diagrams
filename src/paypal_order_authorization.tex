...
\draw[solidarrow]
(0.21,0) -- node[txt, txt, midway,above] {1 Submits authorization request} (14.79,0);
% Flow "2 Reserves funds for further capture"
\draw[solidarrow]
(15.21,0) -- (15.61,0) -- node[txt, txt, midway,right] {2 Reserves funds for further capture} (15.61,-1.25) -- (15.21,-1.25);
