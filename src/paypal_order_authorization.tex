...
% Flows
% Flow "1 Submits _authorization_ request"
\draw[solidarrow, txt]
(0.21,0) -- node[midway,above] {1 Submits \textit{authorization} request} (14.79,0);
% Flow "2 Reserves funds for further capture"
\draw[solidarrow, txt]
(15.21,0) -- (15.61,0) -- node[midway,right] {2 Reserves funds for further capture} (15.61,-1.25) -- (15.21,-1.25);
