...
\draw[solidarrow, txt]
(0.21,0) -- node[midway,above] {1 Enters credit card details at checkout} (8.79,0);
% Flow "2 Records data"
\draw[solidarrow, txt]
(9.21,0) -- (9.61,0) -- node[midway,right] {2 Records data} (9.61,-1.25) -- (9.21,-1.25);
% Flow "3 Posts XML request with default identifiers"
\draw[solidarrow, txt]
(9.21,-2.5) -- node[midway,above] {3 Posts XML request with default identifiers} (17.79,-2.5);
% Flow "4 Processes request"
\draw[solidarrow, txt]
(18.21,-2.5) -- (18.61,-2.5) -- node[midway,right] {4 Processes request} (18.61,-3.75) -- (18.21,-3.75);
% Flow "5 Forwards transaction details"
\draw[solidarrow, txt]
(18.21,-5) -- node[midway,above] {5 Forwards transaction details} (26.79,-5);
% Flow "6 Acquires card and sales details"
\draw[solidarrow, txt]
(27.21,-5) -- (27.61,-5) -- node[midway,right] {6 Acquires card and sales details} (27.61,-6.25) -- (27.21,-6.25);
% Flow "7 Checks identifiers and \\ merchant's details"
\draw[solidarrow, txt]
(27.21,-7.5) -- (27.61,-7.5) -- node[midway,right] {7 Checks identifiers and \\ merchant's details} (27.61,-8.75) -- (27.21,-8.75);
% Flow "8 Complements data with data from transaction identifier tag"
\draw[solidarrow, txt]
(27.21,-10) -- (27.61,-10) -- node[midway,right] {8 Complements data with data from transaction identifier tag} (27.61,-11.25) -- (27.21,-11.25);
% Flow "9 Routes settlement request incl. Dynamic Descriptor"
\draw[solidarrow, txt]
(27.21,-13.75) -- node[midway,above] {9 Routes settlement request incl. Dynamic Descriptor} (35.79,-13.75);
% Flow "10 Processes request and debits consumer's account"
\draw[solidarrow, txt]
(36.21,-13.75) -- (36.61,-13.75) -- node[midway,right] {10 Processes request and debits consumer's account} (36.61,-15) -- (36.21,-15);
% Flow "11 Adds new debit item with \\ Dynamic Descriptor to credit card statement"
\draw[solidarrow, txt]
(36.21,-16.25) -- (36.61,-16.25) -- node[midway,right] {11 Adds new debit item with \\ Dynamic Descriptor to credit card statement} (36.61,-17.5) -- (36.21,-17.5);
