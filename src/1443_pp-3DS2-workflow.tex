...
\begin{tikzpicture}
  ...
  \node[icon] (icon1) at (-5,2)
       {\includegraphicons[width=.1\textwidth]{useralt.png}};
       \node[pt2] at (5,1) {Merchant System};
       \node[icon] (icon2) at (5,2)
            {\includegraphicons[width=.1\textwidth]{connection.png}};
            \node[pt3] at (15,1) {WPG};
            \node[icon] (icon3) at (15,2)
                 {\includegraphicons[width=.1\textwidth]{bigdata.png}};
                 \node[pt4] at (25,1) {Wirecard 3DS Router};
                 \node[icon] (icon4) at (25,2)
                      {\includegraphicons[width=.1\textwidth]{intgsolutions.png}};
