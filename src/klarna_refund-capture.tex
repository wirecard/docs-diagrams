...
\draw[solidarrow, txt]
(0.21,0) -- node[midway,above] {1 Refunds order} (14.79,0);
% Flow "2 Creates refund-capture \\ transaction"
\draw[solidarrow, txt]
(15.21,-1.25) -- node[midway,above] {2 Creates refund-capture \\ transaction} (29.79,-1.25);
% Flow "3 Refunds order"
\draw[solidarrow, txt]
(30.21,-1.25) -- (30.61,-1.25) -- node[midway,right] {3 Refunds order} (30.61,-2.5) -- (30.21,-2.5);
