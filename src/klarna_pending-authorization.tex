...
\draw[dashedarrow] (18.98119355564303,-10) -- node[txt, left] {ok} (18.98119355564303,-12.5) -- (18.375755777990218,-12.5);
\draw[solidarrow]
...
\draw[dashedarrow] (20,-10) -- node[txt, right] {nok} (20,-15) -- (19.394562222347187,-15);
\draw[solidarrow]
...
\draw[dashedarrow] (21.01880644435697,-10) -- node[txt, right] {pending} (21.01880644435697,-17.5) -- (20.205437777652815,-17.5);
