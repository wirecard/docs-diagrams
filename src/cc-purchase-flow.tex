...
%   \node (Start) [start_end, above of= purchase, node distance=15] {Start};
   \node[decision, right of= purchase, node distance=158] (decision1) {Funds\\ transfer\\ triggered?};
   ...
   \node[decision, below of= refund-purchase, node distance=112] (decision2) {Funds\\ transfer\\ triggered?};
      \node[transaction] (void-refund-purchase) at (decision2 -| void-purchase)  {void-refund-purchase};
   \node[start_end, below of= void-refund-purchase, node distance=90] (end) {End};
