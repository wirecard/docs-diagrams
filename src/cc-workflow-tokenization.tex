...
\node[txt, participant] at (0,0) {Consumer};
	\node[txt, icon] (icon1) at (0,1)
	{\includegraphics[width=.1\textwidth] {consumer.png}};
\node[txt, participant] at (10,0) {Merchant};
	\node[txt, icon] (icon2) at (10,1)
	{\includegraphics[width=.1\textwidth]{merchant.png}};
\node[txt, participant] at (20,0) {Payment Gateway};
	\node[txt, icon] (icon3) at (20,1)
