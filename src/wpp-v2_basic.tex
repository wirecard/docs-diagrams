...
\node (question) [question] at (5,-9.5) {Transaction \\ successful?};
    				\draw[dashedarrow]
    				(4.3,-10.2) -- node[txt, left, text width=0.7cm] {yes} (4.3,-11.6) -- (3.8,-11.6);
    				\draw[dashedarrow]
    				(5.7,-10.2) -- node[txt, right] {no} (5.7,-13.1) -- (5.2,-13.1); 
	
\draw[solidarrow]
	(3.7,-11.6) -- node[txt_right, above] {10.1 Redirects to success page} (-4.8,-11.6);  
\draw[solidarrow]
	(4.8,-13.1) -- node[txt_right, above] {10.2 Redirects to fail page} (-4.8,-13.1);  
\end{tikzpicture}
\end{document}
