...
\draw[solidarrow]
	(2.7,-11.6) -- node[txt_right, above] {10.1 Redirects consumer \\ to success page} (-4.8,-11.6);  
\draw[solidarrow]
	(2.7,-13.1) -- node[txt_right, above] {10.2 Redirects consumer \\ to fail page} (-4.8,-13.1);  
\end{tikzpicture}
\end{document}
