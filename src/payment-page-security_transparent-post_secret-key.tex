...
\begin{tikzpicture}
% Participants
\node[night, font=\Large, text width=4cm, align=center, below] (Merchant) at (-5,2) {Merchant\\ Domain};
...
\node[night, font=\Large, text width=6cm, align=center, below] (Wirecard) at (5,2) {\wdpaymentprovidername\\ Domain};
\node[icon] (icon3) at (5,3)
